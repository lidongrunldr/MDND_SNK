...
dataset_path = osp.join("/home/mj/ICCV/data/smal")
pretrain_path = osp.join("/home/mj/ICCV/data/DT4D/save_models/2025_03_02__09_21_09/best.pth".format(input_features))
...
#TOSCA和SMAL分别在5和3采取迭代率下降方法
    ...
    # 定义你想要的特定形状对
    # target_name_x = "tr_reg_022"  # 替换为你想要的 name_x
    # target_name_y = "tr_reg_020"  # 替换为你想要的 name_y

    # 筛选出符合条件的数据对
    # filtered_data = [
    #     data for data in train_loader
    #     if data[-11] == target_name_x and data[-1] == target_name_y
    # ]

    # if not filtered_data:
    #     print(f"No matching data found for {target_name_x} and {target_name_y}")
    #     return
    # for data in tqdm(filtered_data):  # 遍历筛选后的数据对
    # sampled_data = random.sample(list(train_loader), 1)
    ...
    # for data in tqdm(train_loader):
        ...
        for _ in range(500):
            ...
            obj1 = r"/home/mj/h/data/SMAL_r/off/"+name_y+".off"
            obj2 = r"/home/mj/h/data/SMAL_r/off/"+name_x+".off"
            ...
            if iter%100==0:
                ...
                print(f'erro_i:{erro_i}')
        
        erro_i_sub += erro_i
        print(f'erro_i_sub:{erro_i_sub}')
        results_dir = osp.join("/home/mj/ICCV/data/smal/p12")
        results_path=osp.join(results_dir,name_x+'_'+name_y+'.mat')
        p12=torch.tensor(p12)
        sio.savemat(results_path, {
                                    'p12':p12.numpy().astype(np.int64)+1,
                                'erro_i':erro_i}) # T: convert to matlab index
    erro_i_end = erro_i_sub / len(test_loader)
    print("erro_i_end ", erro_i_end)
    ...
    sio.savemat('smal_loss.mat', {'all_loss1': all_loss1})
...
# Test
# test_dataset = MatchingDataset("/home/mj/ICCV/data/DT4D", train=False, k_eig=k_eig, use_cache=True)
# test_loader = DataLoader(test_dataset, batch_size=None)
...
#         # Apply the model
#         p12= model.model_test_opt(descs_x,massvec_x,evals_x,evecs_x,gs_x,gradX_x,gradY_x,elevals_x,elevecs_x,\
...
#         # data_x=sio.loadmat("/home/mj/tog/SMAL_r/dist/"+name_y+'.mat')
#         # dist_x=data_x["dist"]

#         # corr_x_file="/home/mj/tog/SMAL_r/corres/"+name_y+'.vts'
#         # arrays_corr_x = []
#         # with open(corr_x_file, 'r') as file:
#         #    for line in file:
#         #      numbers = int(line.strip())
...
#         # corr_y_file="/home/mj/tog/SMAL_r/corres/"+name_x+'.vts'
#         # arrays_corr_y = []
#         # with open(corr_y_file, 'r') as file:
#         #    for line in file:
#         #      numbers = int(line.strip())
...
#         # # idx1,idx2=combinations[count]
#         # data_x=sio.loadmat("/home/mj/hybridfmaps/data/TOPKIDS/dist/"+name1+'.mat')
#         # dist_x=data_x["dist"]

#         # corr_x_file="/home/mj/hybridfmaps/data/TOPKIDS/corres/"+name2+'_ref.vts'
#         # arrays_corr_x = []
#         # with open(corr_x_file, 'r') as file:
#         #    for line in file:
#         #      numbers = int(line.strip())
...
#         # # idx1,idx2=combinations[count]
#         # data_x=sio.loadmat("/home/mj/hybridfmaps/data/DT4D/dist_r/"+name2+'.mat')
#         # dist_x=data_x["dist"]

#         # corr_x_file="/home/mj/hybridfmaps/data/DT4D/corres_intra/"+name2+'.vts'
#         # arrays_corr_x = []
#         # with open(corr_x_file, 'r') as file:
#         #    for line in file:
#         #      numbers = int(line.strip())
...
#         # corr_y_file="/home/mj/hybridfmaps/data/DT4D/corres_intra/"+name1+'.vts'
#         # arrays_corr_y = []
#         # with open(corr_y_file, 'r') as file:
#         #    for line in file:
#         #      numbers = int(line.strip())
