...
class MatchingDataset(Dataset):
    def __init__(self,root_dir,train,k_eig=128,Nf=6,use_cache=True):
        ...
        if use_cache:
            ...
            if os.path.exists(load_cache):
                ...
                if self.train:
                    ...
                    self.combinations=list(permutations(range(len(self.evals_list)), 2))[:25]
                return
        ...
        for name in self.names:
            ...
            elevals=sio.loadmat(osp.join("/home/mj/RFMNet/data/TOPKIDS/elevals",name+'.mat'))['elevals']
            self.elevals_list.append(torch.from_numpy(elevals))
            elevecs=sio.loadmat(osp.join("/home/mj/RFMNet/data/TOPKIDS/elevecs_zj",name+'.mat'))['elevecs_zj']
