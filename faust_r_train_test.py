...
pretrain_path = osp.join("/home/mj/ICCV/data/SCAPE/save_models/2025_05_08__23_17_38/best.pth".format(input_features))
...
#TOSCA和SMAL分别在5和3采取迭代率下降方法
    ...
    sampled_data = random.sample(list(train_loader), 20)
    ...
    #模型保存iter分别为FAUST和SCAPE是500，TOSCA是214，SMAL是992、dt4d分别是全部完整的训练数据（5292_inter、3410_intra）、TOPKIDS 650、shrec19 1892
        ...
        results_dir = osp.join("/home/mj/ICCV/data/SCAPE/P12")
    ...
    sio.savemat('scape_loss.mat', {'all_loss1': all_loss1})
...
# Test
# test_dataset = MatchingDataset("/home/mj/ICCV/data/SCAPE", train=False, k_eig=k_eig, use_cache=True)
# test_loader = DataLoader(test_dataset, batch_size=None)
